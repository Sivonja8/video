...
client.on('message', message => {
    if (message.content === '-help') {
        ...
        .addField(':tada: **join**', 'Summons the bot to your voice channel.')
        .addField(':tada: **disconnect**', 'Disconnect the bot from the voice channel it is in.')
        .addField(':tada: **skip**', 'Skips the currently playing song.')
        .addField(':tada: **pause**', 'Pauses the currently playing track.')
...
e.set_footer(text='Just-Some-Bots/MusicBot ({})', icon_url='https://i.imgur.com/gFHBoZA.png')
